...
export default function RoadwaysWeightwisePage() {
  ...
  async function onSubmit(e: FormEvent) {
    ...
    try {
      const result = await api<{ bill: Bill; lrCount: number }>("/api/bills/generate", {
        method: "POST",
        body: JSON.stringify({ ...form, billAs: "Weight", source: "ROADWAYS" }),
      });
  ...
  return (
    <>
      <PageHeader title="Bill Weightwise" subtitle="Fill all the fields" crumbs={[{ label: "Home", href: "/" }, { label: "Bill Weightwise" }]} />
