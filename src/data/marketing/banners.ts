...
export const homeBanners: HomeBanner[] = [
  {
    ...
    branches: [
      ...
      { code: "PUN", name: "Pune", phone: company.phone, phoneAlt: company.phoneAlt },
      { code: "MUM", name: "Mumbai", phone: company.phone, phoneAlt: company.phoneAlt },
      { code: "AMD", name: "Ahmedabad", phone: company.phone, phoneAlt: company.phoneAlt },
      { code: "SUR", name: "Surat", phone: company.phone, phoneAlt: company.phoneAlt },
    ],
